...
function ProductTable({products , inStockOnly, filterText})
{
    ...
    products.forEach(product=>{
        ...
        if((inStockOnly && !product.stocked) || (filterText!='' && product.name.indexOf(filterText)===-1))
        { 
          return
        }
        ...
        if(product.category !== lastCategory)
        {
            ...
            rows.push(<ProductCategorieRow key={lastCategory} category={lastCategory}/>)
        }
      ...
      return (
        <div className="mb-3">
            ...
            <div className="form-check">
                <input type="checkbox" checked={inStockOnly} onChange={this.handleInStockOnlyChange}  className="form-check-input" id="stock"></input>
